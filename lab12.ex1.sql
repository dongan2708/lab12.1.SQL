...
INSERT INTO Project VALUES (1111, 'chính phủ điện tử', '2010-2-4','2010-5-5', 3,4000000),
...
WHERE ProjectName ='chính phủ điện tử'
...
FROM ProjectWHERE StartDate < EndDate
--b. Trường tên nhân viên không được null
SELECT EmployeeID, Name
FROM EmployeeWHERE Name is NOT Null
...
--5. Tạo các thủ tục lưu trữ thực hiện: --a. Tăng giá thêm 10% của các dự án có tổng giá trị nhỏ hơn 21000000
...
CREATE TRIGGER CheckEndDateInser
tON Project 
after INSERT
AS 
	BEGIN 
